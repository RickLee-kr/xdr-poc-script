"""JSP webshell provider session model."""
...
JSP_PROVIDER_VERSION = "1.0.0"


@dataclass
class JspProviderSession(GenericWebshellSession):
    """JSP provider session metadata — extends generic session with JSP defaults."""

    provider_version: str = JSP_PROVIDER_VERSION
    ...
    def new(
        ...
        *,
        ...
        """Create a JSP session record without transport side effects."""
        return super().new(
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> JspProviderSession:
        ...
        return cls(
            ...
            provider_version=str(data.get("provider_version", JSP_PROVIDER_VERSION)),
        )

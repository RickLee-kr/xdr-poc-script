"""ASPX webshell runtime — TransportBackedRuntime with ASPX cmd encoding."""
...
class AspxWebshellRuntime(TransportBackedRuntime):
    """ASPX-specific runtime — ``cmd`` GET/POST dispatch via RealHttpTransport."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            command_encoder=AspxCommandEncoder(),
        ...
        *,
        ...
        if transport_method == "send_get":
            return TransportRequest(
                ...
                method="GET",
                params={AspxCommandEncoder.COMMAND_PARAM: encoded_payload},
                timeout_seconds=timeout_seconds,
                metadata={
                    "command_transport": True,
                    "aspx_encoding": "get_cmd_param",
                },
            )
        body = urllib.parse.urlencode(
            {AspxCommandEncoder.COMMAND_PARAM: encoded_payload}
        ).encode("utf-8")
        return TransportRequest(
            url=self._webshell_url,
            method="POST",
            ...
            metadata={
                "command_transport": True,
                "aspx_encoding": "post_cmd_form",
            },
        )

    def execute_command(self, request: CommandRequest) -> CommandResult:
        """Deliver an ASPX command via transport — transport outcome metadata only."""
        ...
        return CommandResult(
            ...
            execution_metadata=self._aspx_execution_metadata(
                transport_method=transport_method,
    ...
    def _aspx_execution_metadata(
        *,
        ...
        return {
            ...
            "delivery_only": True,
            "aspx_command_param": AspxCommandEncoder.COMMAND_PARAM,
        }

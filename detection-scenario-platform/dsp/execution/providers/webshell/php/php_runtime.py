"""PHP webshell runtime — TransportBackedRuntime with PHP cmd encoding."""
...
class PhpWebshellRuntime(TransportBackedRuntime):
    """PHP-specific runtime — ``cmd`` GET/POST dispatch via RealHttpTransport."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            command_encoder=PhpCommandEncoder(),
        ...
        *,
        ...
        if transport_method == "send_get":
            return TransportRequest(
                ...
                method="GET",
                params={PhpCommandEncoder.COMMAND_PARAM: encoded_payload},
                timeout_seconds=timeout_seconds,
                metadata={
                    "command_transport": True,
                    "php_encoding": "get_cmd_param",
                },
            )
        body = urllib.parse.urlencode(
            {PhpCommandEncoder.COMMAND_PARAM: encoded_payload}
        ).encode("utf-8")
        return TransportRequest(
            url=self._webshell_url,
            method="POST",
            ...
            metadata={
                "command_transport": True,
                "php_encoding": "post_cmd_form",
            },
        )

    def execute_command(self, request: CommandRequest) -> CommandResult:
        """Deliver a PHP command via transport — transport outcome metadata only."""
        ...
        return CommandResult(
            ...
            execution_metadata=self._php_execution_metadata(
                transport_method=transport_method,
    ...
    def _php_execution_metadata(
        *,
        ...
        return {
            ...
            "delivery_only": True,
            "php_command_param": PhpCommandEncoder.COMMAND_PARAM,
        }
